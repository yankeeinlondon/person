...
import { EmptyObject, Dictionary, ObjectKey, Tuple, IsEqual, Contains, Keys, Values, HandleDoneFn, AfterFirst, First, AsDictionary, TupleToUnion, ExpandDictionary, NarrowableScalar, ShapeCallback, UnionElDefn, SimpleToken, AsType } from "src/types/index";
 ...
 */
type ToType<T, TElse> = [T] extends [ShapeCallback] ? HandleDoneFn<ReturnType<T>> : [IsDictionaryDefinition<T>] extends [true] ? HandleObject<AsDictionary<T>, Keys<AsDictionary<T>>> : IsEqual<TElse, Constant<"not-set">> extends true ? T : TElse;
/**
