 ...
 */
export type JustFunction<TFn extends TypedFunction> = <T extends readonly unknown[]>(...args: T & Parameters<TFn>) => ReturnType<TFn>;
//# sourceMappingURL=JustFunction.d.ts.map