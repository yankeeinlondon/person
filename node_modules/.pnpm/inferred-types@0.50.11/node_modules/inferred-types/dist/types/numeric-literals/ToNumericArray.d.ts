...
type _Convert<TInput extends Tuple> = IsNonEmptyContainer<TInput> extends true ? {
 ...
 * possible
 */
export type ToNumericArray<TList extends Tuple> = IsReadonlyArray<TList> extends true ? Readonly<_Convert<TList>> : _Convert<TList>;
export {};
