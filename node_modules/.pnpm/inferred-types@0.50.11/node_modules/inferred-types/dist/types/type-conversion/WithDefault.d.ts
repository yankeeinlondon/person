 ...
 * ```
 */
export type WithDefault<TVal, TDef, TPolicy extends "nothing" | "falsy" = "nothing"> = TPolicy extends "nothing" ? If<Extends<TVal, Nothing>, TDef, TVal> : TPolicy extends "falsy" ? If<IsFalsy<TVal>, TDef, TVal> : never;
