 ...
 */
export type StringComparatorOperation = "startsWith" | "endsWith";
export type NumericComparatorOperation = "greaterThan" | "greaterThanOrEqual" | "lessThan" | "lessThanOrEqual";
/**
 * **ComparatorOperation**
 *
 ...
 */
export type ComparatorOperation = "extends" | "equals" | StringComparatorOperation | "contains" | "containsAll" | NumericComparatorOperation | "returnEquals" | "returnExtends";
/**
 ...
 */
export type ParamsForComparison<T extends ComparatorOperation> = T extends "equals" ? readonly [unknown] : T extends "extends" ? readonly [unknown] : T extends "startsWith" ? [string | number] : T extends "endsWith" ? readonly [[string | number] | Tuple<unknown, 1>] : T extends "contains" ? readonly [unknown, ...Tuple[]] : T extends "containsAll" ? readonly [unknown, ...Tuple[]] : T extends "greaterThan" ? readonly [NumberLike] : T extends "greaterThanOrEqual" ? readonly [NumberLike] : T extends "lessThan" ? readonly [NumberLike] : T extends "lessThanOrEqual" ? readonly [NumberLike] : never;
/**
 ...
 * ```
 */
export type Comparison<TOp extends ComparatorOperation = ComparatorOperation, TArgs extends ParamsForComparison<TOp> = ParamsForComparison<TOp>, TFn extends TypedFunction = TypedFunction> = Extends<TArgs, ParamsForComparison<TOp>> extends true ? {
    kind: "Comparison";
    op: TOp;
    args: TArgs;
    fn: TFn;
 ...
 * the `TOp` _operator_.
 */
export type Compare<TVal, TOp extends ComparatorOperation, TComparator> = WhenNever<Process<TVal, TOp, TComparator>>;
export {};
