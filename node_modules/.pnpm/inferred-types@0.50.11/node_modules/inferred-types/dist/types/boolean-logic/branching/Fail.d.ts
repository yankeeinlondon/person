...
type Iterate<TTest extends readonly unknown[]> = Or<{
 ...
 */
export type Fail<TVal, TTest> = [TTest] extends [Tuple] ? [Iterate<TTest>] extends [true] ? never : TVal : [ShouldFail<TTest>] extends [true] ? never : TVal;
export {};
