 ...
 */
export type NarrowlyContains<TList extends readonly unknown[], TContains> = IsEqual<First<TList>, TContains> extends true ? true : [] extends AfterFirst<TList> ? false : NarrowlyContains<AfterFirst<TList>, TContains>;
//# sourceMappingURL=NarrowlyContains.d.ts.map