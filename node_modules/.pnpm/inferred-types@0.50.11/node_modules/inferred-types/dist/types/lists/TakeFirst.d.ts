import { IsGreaterThan, If, Throw, IsEqual, AfterFirst, Increment, First, IsGreaterThanOrEqual } from "src/types/index";
type Process<TContent extends readonly unknown[], TLen extends number, TIdx extends number = 0, TResult extends readonly unknown[] = []> = [] extends TContent ? TResult : If<IsGreaterThanOrEqual<TIdx, TLen>, TResult, Process<AfterFirst<TContent>, TLen, Increment<TIdx>, [
    ...TResult,
    First<TContent>
]>>;
/**
