...
type Process<TValues extends readonly (boolean | LogicFunction)[], _TParams extends readonly unknown[] = []> = {
 ...
 */
export type LogicalReturns<TValues extends readonly (boolean | LogicFunction)[], _TParams extends readonly unknown[] = []> = Process<TValues, _TParams> extends readonly boolean[] ? Process<TValues, _TParams> : never;
export {};
