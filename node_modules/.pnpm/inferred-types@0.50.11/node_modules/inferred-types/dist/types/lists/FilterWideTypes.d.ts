 ...
 */
export type FilterWideTypes<T extends readonly unknown[]> = RemoveMarked<{
    [K in keyof T]: If<IsWideType<T[K]>, Constant<"Marked">, T[K]>;
}>;
//# sourceMappingURL=FilterWideTypes.d.ts.map