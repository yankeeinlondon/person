 ...
 */
export type MakePropsMutable<TObj extends AnyObject, TMutProps extends ObjectKey[] | ObjectKey> = SimplifyObject<Mutable<WithKeys<TObj, TMutProps>> & WithoutKeys<TObj, TMutProps>>;
/**
 ...
 */
export type MutablePropsExclusive<T extends AnyObject, M extends readonly (keyof T & ObjectKey)[]> = ExpandRecursively<Mutable<WithKeys<T, M>> & Readonly<WithoutKeys<T, AsArray<M>>>>;
//# sourceMappingURL=MakePropsMutable.d.ts.map