 ...
 */
export type KebabKeys<T extends Dictionary> = MakeKeysOptional<Process<T, Keys<T>>, OptionalKeys<T> extends string ? UnionMutate<OptionalKeys<T>, "KebabCase"> extends string ? UnionMutate<OptionalKeys<T>, "KebabCase"> : "" : "">;
export {};
//# sourceMappingURL=KebabKeys.d.ts.map