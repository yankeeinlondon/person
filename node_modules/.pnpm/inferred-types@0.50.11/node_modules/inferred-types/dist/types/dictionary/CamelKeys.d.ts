 ...
 */
export type CamelKeys<T extends Dictionary> = MakeKeysOptional<Process<T, Keys<T>>, OptionalKeys<T> extends string ? UnionMutate<OptionalKeys<T>, "CamelCase"> extends string ? UnionMutate<OptionalKeys<T>, "CamelCase"> : "" : "">;
export {};
//# sourceMappingURL=CamelKeys.d.ts.map