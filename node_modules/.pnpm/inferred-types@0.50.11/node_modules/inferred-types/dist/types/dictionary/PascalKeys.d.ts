...
import { PascalCase } from "../string-literals";
...
type Process<TObj extends Dictionary, TKeys extends readonly (ObjectKey & keyof TObj)[], TResult extends Dictionary = EmptyObject> = [] extends TKeys ? ExpandDictionary<TResult> : Process<TObj, AfterFirst<TKeys>, First<TKeys> extends string ? Record<PascalCase<First<TKeys>>, TObj[First<TKeys>]> & TResult : Record<First<TKeys>, TObj[First<TKeys>]> & TResult>;
/**
 * Converts an object's keys to the **camelCase** equivalent
 * while keeping the values the same.
 */
export type PascalKeys<T extends Dictionary> = MakeKeysOptional<Process<T, Keys<T>>, OptionalKeys<T> extends string ? UnionMutate<OptionalKeys<T>, "PascalCase"> extends string ? UnionMutate<OptionalKeys<T>, "PascalCase"> : "" : "">;
export {};
//# sourceMappingURL=PascalKeys.d.ts.map