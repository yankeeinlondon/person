import { ENERGY_METRICS_LOOKUP } from "src/constants/index";
...
export type EnergyMetrics = {
    [K in keyof EnergyMetricsLookup]: "name" extends keyof EnergyMetricsLookup[K] ? EnergyMetricsLookup[K]["name"] : never;
}[number];
/**
 * Unit of measure for metrics associated with **Energy**.
 */
export type EnergyUom = {
    [K in keyof EnergyMetricsLookup]: "abbrev" extends keyof EnergyMetricsLookup[K] ? EnergyMetricsLookup[K]["abbrev"] : never;
}[number];
/***
 * **Energy**
 *
