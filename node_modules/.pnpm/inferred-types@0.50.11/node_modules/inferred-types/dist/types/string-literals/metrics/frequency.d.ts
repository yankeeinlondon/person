import { FREQUENCY_METRICS_LOOKUP } from "src/constants/index";
...
export type FrequencyMetrics = {
    [K in keyof FrequencyMetricsLookup]: "name" extends keyof FrequencyMetricsLookup[K] ? FrequencyMetricsLookup[K]["name"] : never;
}[number];
/**
 * Unit of measure for metrics associated with **Frequency**.
 */
export type FrequencyUom = {
    [K in keyof FrequencyMetricsLookup]: "abbrev" extends keyof FrequencyMetricsLookup[K] ? FrequencyMetricsLookup[K]["abbrev"] : never;
}[number];
/***
 * **Frequency**
 *
