import { TIME_METRICS_LOOKUP } from "src/constants/index";
...
export type TimeMetrics = {
    [K in keyof TimeMetricsLookup]: "name" extends keyof TimeMetricsLookup[K] ? TimeMetricsLookup[K]["name"] : never;
}[number];
/**
 * Unit of measure for metrics associated with **Time**.
 */
export type TimeUom = {
    [K in keyof TimeMetricsLookup]: "abbrev" extends keyof TimeMetricsLookup[K] ? TimeMetricsLookup[K]["abbrev"] : never;
}[number];
/***
 * **Time**
 *
