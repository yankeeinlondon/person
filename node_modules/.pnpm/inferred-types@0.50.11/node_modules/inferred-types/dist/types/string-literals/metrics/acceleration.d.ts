import { ACCELERATION_METRICS_LOOKUP } from "src/constants/index";
...
export type AccelerationMetrics = {
    [K in keyof AccelerationMetricsLookup]: "name" extends keyof AccelerationMetricsLookup[K] ? AccelerationMetricsLookup[K]["name"] : never;
}[number];
/**
 * Unit of measure for metrics associated with **Acceleration**.
 */
export type AccelerationUom = {
    [K in keyof AccelerationMetricsLookup]: "abbrev" extends keyof AccelerationMetricsLookup[K] ? AccelerationMetricsLookup[K]["abbrev"] : never;
}[number];
/***
 * **Acceleration**
 *
