 ...
 */
export type SingularNoun<T extends string> = T extends `${infer Prelude}${SingularNounEnding}` ? If<AllExtend<Chars<Prelude>, AlphaChar>, T, never> : never;
//# sourceMappingURL=SingularNoun.d.ts.map