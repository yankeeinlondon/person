...
export type LuminosityMetrics = {
    [K in keyof LuminosityMetricsLookup]: "name" extends keyof LuminosityMetricsLookup[K] ? LuminosityMetricsLookup[K]["name"] : never;
}[number];
/**
 * Unit of measure for metrics associated with **Luminosity**.
 */
export type LuminosityUom = {
    [K in keyof LuminosityMetricsLookup]: "abbrev" extends keyof LuminosityMetricsLookup[K] ? LuminosityMetricsLookup[K]["abbrev"] : never;
}[number];
/***
 * **Luminosity**
 *
