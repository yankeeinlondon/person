import { AfterFirst, First, Tuple, IsStringLiteral, IsNumericLiteral, IsBooleanLiteral } from "src/types/index";
...
type Process<T extends Tuple, Result extends string = ""> = [] extends T ? Result : Process<AfterFirst<T>, `${Result}${ElementLiteral<First<T>>}`>;
/**
 * **Concat**`<T>`
 *
 ...
 */
export type Concat<T extends readonly unknown[]> = Process<T>;
export {};
