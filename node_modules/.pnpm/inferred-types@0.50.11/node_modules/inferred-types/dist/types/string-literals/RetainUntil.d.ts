 ...
 * **Related:** `RetainWhile`
 */
export type RetainUntil<TContent extends string, TComparator extends string, TInclude extends boolean = false> = Process<Chars<TContent>, "not", TComparator, TInclude>;
/**
