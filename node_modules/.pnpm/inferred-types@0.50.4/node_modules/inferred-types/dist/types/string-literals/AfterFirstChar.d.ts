...
type Iterate<TInput extends readonly string[]> = {
    [K in keyof TInput]: TInput[K] extends string ? Concat<AfterFirst<AsArray<Chars<TInput[K]>>>> : never;
};
/**
 ...
 */
export type AfterFirstChar<TContent extends string | readonly string[]> = TContent extends readonly string[] ? Iterate<AsArray<TContent>> : TContent extends string ? Concat<AfterFirst<AsArray<Chars<AsString<TContent>>>>> : never;
export {};
//# sourceMappingURL=AfterFirstChar.d.ts.map