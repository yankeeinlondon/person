 ...
 */
export type IsLowerAlpha<T> = T extends string ? If<IsStringLiteral<T>, IfAllExtend<AsArray<Chars<T>>, LowerAlphaChar, T, never>, string> : never;
//# sourceMappingURL=LowerAlpha.d.ts.map