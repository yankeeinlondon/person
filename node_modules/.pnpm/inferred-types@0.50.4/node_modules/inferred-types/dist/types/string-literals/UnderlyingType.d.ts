...
type Process<T> = T extends NumberLike ? AsNumber<T> : T extends BooleanLike ? AsBoolean<T> : T;
/**
 * **UnderlyingType**`<T>`
 *
 ...
 */
export type UnderlyingType<T> = T extends readonly unknown[] ? {
    [K in keyof T]: Process<T[K]>;
} : Process<T>;
export {};
//# sourceMappingURL=UnderlyingType.d.ts.map