...
import { SimpleType, SimpleTypeMap, SimpleTypeDict, SimpleTypeSet, SimpleTypeArray, SimpleTypeScalar, SimpleTypeUnion } from "./SimpleType";
import { SimpleDictToken, SimpleMapToken, SimpleSetToken, SimpleArrayToken, SimpleScalarToken, SimpleToken, SimpleUnionToken, TypeToken } from "./TypeToken";
 ...
 */
export type AsType<T extends SimpleToken | readonly SimpleToken[] | TypeToken> = T extends readonly SimpleToken[] ? Iterate<T> : T extends SimpleToken ? ProcessSimple<T> : never;
export {};
