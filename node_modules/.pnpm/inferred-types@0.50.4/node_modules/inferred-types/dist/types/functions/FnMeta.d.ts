import { AnyFunction, Dictionary, IsNarrowingFn, IsNonEmptyObject } from "src/types/index";
/**
 ...
 */
export type FnMeta<TFn extends AnyFunction = AnyFunction, TArgs extends readonly any[] = readonly any[], TReturn = unknown, TProps extends Dictionary = Dictionary> = {
    fn: TFn;
    args: TArgs;
    returns: TReturn;
    props: TProps;
