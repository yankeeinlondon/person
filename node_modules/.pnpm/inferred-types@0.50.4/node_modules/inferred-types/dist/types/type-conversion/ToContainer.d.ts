import { AnyArray, AnyFunction, AnyObject, Scalar, IfEqual, IfNever } from "src/types/index";
/**
 * **ToContainer**`<T>`
 *
 ...
 */
export type ToContainer<T> = IfNever<Exclude<T, Scalar | undefined | AnyFunction>, AnyObject | AnyArray, IfEqual<Exclude<T, Scalar | undefined | AnyFunction>, any, [
    any
], IfEqual<Exclude<T, Scalar | undefined | AnyFunction>, unknown, [
    unknown
], Exclude<T, Scalar | undefined | AnyFunction>>>>;
//# sourceMappingURL=ToContainer.d.ts.map