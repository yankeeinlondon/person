import { TakeFirst, Reverse } from "src/types/index";
/**
 ...
 */
export type TakeLast<TContent extends readonly unknown[], TLen extends number, THandle extends "ignore" | "throw" = "ignore"> = TakeFirst<Reverse<TContent>, TLen, THandle>;
