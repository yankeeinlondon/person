import { Chars, Concat, Handle, IsEqual, Pop, Tuple } from "src/types/index";
/**
 * **BeforeLast**`<T>`
 *
 * Returns:
 ...
 */
export type BeforeLast<T extends Tuple | string> = T extends string ? string extends T ? string : IsEqual<T, ""> extends true ? "" : Pop<Chars<T>> extends readonly string[] ? Concat<Pop<Chars<T>>> : never : T extends Tuple ? Handle<Pop<T>, never, []> : never;
//# sourceMappingURL=BeforeLast.d.ts.map