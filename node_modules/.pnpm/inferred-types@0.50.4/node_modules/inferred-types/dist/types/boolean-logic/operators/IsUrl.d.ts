import { And, Extends, GetUrlPath, GetUrlSource, IsNever, IsStringLiteral, NetworkProtocol, NetworkProtocolPrefix, Not, Or } from "src/types/index";
...
export type HasNetworkProtocolReference<TTest extends string, TProto extends NetworkProtocol> = Extends<TTest, `${NetworkProtocolPrefix<TProto>}${string}`>;
/**
 ...
 * without a protocol.
 */
export type IsUrl<TTest, TProtocol extends NetworkProtocol | "optional" = "https"> = TTest extends string ? IsStringLiteral<TTest> extends true ? And<[
    Or<[
        HasNetworkProtocolReference<TTest, TProtocol extends NetworkProtocol ? TProtocol : "https">,
