 ...
 * **Related:** `IfError`
 */
export type IfErrorCondition<T, IF, ELSE = T> = IsErrorCondition<T> extends true ? T extends ErrorConditionShape ? IF : never : ELSE;
//# sourceMappingURL=IfErrorCondition.d.ts.map