 ...
 */
export type IsErrorCondition<TEval, TKind extends string | null = null> = TEval extends ErrorCondition ? TKind extends string ? TEval extends ErrorCondition<TKind> ? true : false : true : false;
//# sourceMappingURL=IsErrorCondition.d.ts.map