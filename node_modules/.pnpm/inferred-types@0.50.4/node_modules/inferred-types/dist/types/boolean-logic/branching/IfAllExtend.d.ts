 ...
 */
export type IfAllExtend<TList extends readonly unknown[], TExtend, IF, ELSE> = AllExtend<TList, TExtend> extends true ? IF : ELSE;
//# sourceMappingURL=IfAllExtend.d.ts.map