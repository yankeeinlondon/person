 ...
 */
export declare function omit<TObj extends Record<ObjectKey, N>, N extends Narrowable, TKeys extends readonly ObjectKey[] = readonly []>(obj: TObj, ...removeKeys: TKeys): WithoutKeys<TObj, TKeys>;
