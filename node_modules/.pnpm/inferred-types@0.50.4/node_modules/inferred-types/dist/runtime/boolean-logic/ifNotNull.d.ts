 ...
 */
export declare function ifNotNull<T extends Narrowable, IF extends Narrowable, ELSE extends Narrowable>(val: T, ifVal: (v: Exclude<T, null>) => IF, elseVal: () => ELSE): If<Not<IsNull<T>>, IF, ELSE>;
//# sourceMappingURL=ifNotNull.d.ts.map