 ...
 */
export declare function ifNumber<TContent extends Narrowable, TIf extends Narrowable, TElse extends Narrowable>(val: TContent, ifVal: <V extends TContent & number>(v: V) => TIf, elseVal: <V extends Exclude<TContent, number>>(v: V) => TElse): IsNumber<TContent> extends true ? TIf : TElse;
//# sourceMappingURL=ifNumber.d.ts.map