 ...
 */
export declare function ifFalse<T extends boolean, IF extends Narrowable, ELSE extends Narrowable>(val: T, ifVal: IF, elseVal: ELSE): If<IsFalse<T>, IF, ELSE>;
//# sourceMappingURL=ifFalse.d.ts.map