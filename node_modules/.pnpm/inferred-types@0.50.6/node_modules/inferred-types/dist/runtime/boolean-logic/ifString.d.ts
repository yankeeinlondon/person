 ...
 */
export declare function ifString<TContent, TIf extends Narrowable, TElse extends Narrowable>(val: TContent, ifVal: <V extends TContent & string>(t: V & TContent) => TIf, elseVal: <V extends Exclude<TContent, string>>(v: V & TContent) => TElse): If<IsTrue<IsString<TContent>>, TIf, If<IsFalse<IsString<TContent>>, TElse, TIf | TElse>>;
//# sourceMappingURL=ifString.d.ts.map