 ...
 * ```
 */
export type ContainerBlockKey<TContainer extends Container, TKey extends PropertyKey> = TContainer extends Tuple ? TContainer & [...Tuple<unknown, TKey & number>, never] : Exclude<TContainer, TKey>;
//# sourceMappingURL=ContainerBlockKey.d.ts.map