 ...
 * property from **VueJS**.
 */
export type IsComputedRef<T> = T extends {
    value: unknown;
    effect: object;
} ? true : false;
/**
 ...
 */
export type AsVueComputedRef<T> = T extends VueComputedRef ? T & VueComputedRef : never;
//# sourceMappingURL=VueComputedRef.d.ts.map