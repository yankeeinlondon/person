 ...
 * ```
 */
export type FromDictArray<T extends [string, Record<string, unknown>][]> = ExpandRecursively<UnionToIntersection<T[number][1]>>;
//# sourceMappingURL=FromDictArray.d.ts.map