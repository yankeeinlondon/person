...
export type KeysEqualValue<TObj extends object, TWithValue> = {
    [K in keyof TObj]: TObj[K] extends readonly unknown[] ? IfEqual<TObj[K], TWithValue, K, never> : IfEqual<TObj[K], TWithValue, K, never>;
}[keyof TObj];
//# sourceMappingURL=KeysEqualValue.d.ts.map