import { AsString, HexadecimalChar, IsStringLiteral, NumericChar, NumericCharZeroToFive, ReplaceAll, StripTrailing, Suggest, UnionToTuple } from "src/types/index";
 ...
 * **Related:** `Ip6Subnet`
 */
export type Ip6Address = `${string}:${string}:${string}:${string}:${string}:${string}:${string}:${string}` | `${string}::${string}:${string}:${string}:${string}:${string}:${string}` | `${string}:${string}::${string}:${string}:${string}:${string}:${string}` | `${string}:${string}:${string}::${string}:${string}:${string}:${string}` | `${string}:${string}:${string}:${string}::${string}:${string}:${string}` | `${string}:${string}:${string}:${string}:${string}::${string}:${string}` | `${string}:${string}:${string}:${string}:${string}:${string}::${string}` | `${string}:${string}:${string}:${string}:${string}:${string}:${string}::`;
export type Ip6SubnetPrefix = `${string}:${string}:${string}:${string}`;
export type AsIp6Prefix<T extends readonly Ip6Group[]> = T extends [Ip6Group] ? `${T[0]}:${string}:${string}:${string}` : T extends [Ip6Group, Ip6Group] ? `${T[0]}:${T[1]}:${string}:${string}` : T extends [Ip6Group, Ip6Group, Ip6Group] ? `${T[0]}:${T[1]}:${T[2]}:${string}` : T extends [Ip6Group, Ip6Group, Ip6Group, Ip6Group, ...Ip6Group[]] ? `${T[0]}:${T[1]}:${T[3]}:${T[4]}` : `${string}:${string}:${string}:${string}`;
/**
 * An IPv6 subnet.
 *
 ...
 * ```
 */
export type Ip6Subnet<TPrefix extends Ip6SubnetPrefix = Ip6SubnetPrefix, TMask extends number = number> = `${TPrefix}::/${TMask}`;
/**
 * **SuggestIpAddress**
 *
