 ...
 */
export type BareCssSelector<TId extends CssIdSelector = CssIdSelector, TClass extends CssClassSelector = CssClassSelector, TTag extends CssTagSelector = CssTagSelector> = TId | TTag | TClass;
/**
 * **CssSelector**`<[TId],[TClass],[TTag],[TPseudo]>`
 *
 * A strongly typed **CSS** _selector_.
 */
export type CssSelector<TId extends CssIdSelector = CssIdSelector, TClass extends CssClassSelector = CssClassSelector, TTag extends CssTagSelector = CssTagSelector, TPseudo extends CssPseudoClass = CssPseudoClass> = TId | TClass | TTag | `${TId}${CssPseudoClassDefn<TPseudo>}` | `${TClass}${CssPseudoClassDefn<TPseudo>}` | `${TTag}${CssPseudoClassDefn<TPseudo>}`;
