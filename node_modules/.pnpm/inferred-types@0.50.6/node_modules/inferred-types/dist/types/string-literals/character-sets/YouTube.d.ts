import { AsString, Contains, HasQueryParameter, IsEqual, IsUnion, Last, Split, TupleToUnion, UnionToTuple, AnyQueryParams, GetUrlPath, UrlsFrom, Optional } from "src/types/index";
/**
 * **YouTubePageType**
 *
 ...
 */
export type YouTubeVideoUrl = `https://www.youtube.com/watch?${string}v=${string}` | `https://youtube.com/watch?${string}v=${string}` | YouTubeShareUrl;
/**
 * **YouTubeCreatorUrl**
 *
