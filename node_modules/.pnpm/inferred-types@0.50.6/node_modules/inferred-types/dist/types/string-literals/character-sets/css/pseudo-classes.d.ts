 ...
 */
export type CssDisplayStatePseudoClasses = ":fullscreen" | ":modal" | ":picture-in-picture";
/**
 ...
 */
export type CssInputPseudoClasses = ":autofill" | ":enabled" | ":disabled" | ":readonly-only" | ":read-write" | ":placeholder-shown" | ":default" | ":checked" | ":indeterminate" | ":blank" | ":valid" | ":invalid" | ":in-range" | ":out-of-range" | ":required" | ":optional" | ":user-valid" | ":user-invalid";
/**
 ...
 */
export type CssLinguisticPseudoClasses = ":dir" | ":lang";
/**
 ...
 * current document.
 */
export type CssLocationPseudoClasses = ":any-link" | ":link" | ":visited" | ":local-link" | ":target" | ":target-within" | ":scope";
/**
 ...
 */
export type CssResourceStatePseudoClasses = ":playing" | ":paused";
/**
 ...
 */
export type CssTimePseudoClasses = ":current" | ":past" | ":future";
/**
 ...
 * document tree.
 */
export type CssTreePseudoClasses = ":root" | ":empty" | ":nth-child" | ":nth-last-child" | ":first-child" | ":last-child" | ":only-child" | ":nth-of-type" | ":nth-last-of-type" | ":first-of-type" | ":last-of-type" | ":only-of-type";
/**
 ...
 */
export type CssUserActionPseudoClasses = ":hover" | ":active" | ":focus" | ":focus-visible" | ":focus-within";
/**
 ...
 * as a parameter.
 */
export type CssFunctionalPseudoClass = ":is" | ":not" | ":where" | ":has";
/**
 ...
 */
export type CssPseudoClass = CssDisplayStatePseudoClasses | CssFunctionalPseudoClass | CssInputPseudoClasses | CssLinguisticPseudoClasses | CssLocationPseudoClasses | CssResourceStatePseudoClasses | CssTimePseudoClasses | CssTreePseudoClasses | CssUserActionPseudoClasses;
/**
 * **CssPseudoClassDefn**
 *
 * A type which incorporates a definition of _all_ CSS pseudo classes.
 */
export type CssPseudoClassDefn<T extends CssPseudoClass = CssPseudoClass> = `${T}(${string})`;
