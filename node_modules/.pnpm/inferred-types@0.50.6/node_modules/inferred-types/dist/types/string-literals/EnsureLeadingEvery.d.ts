 ...
 */
export type EnsureLeadingEvery<TList extends readonly (string | number | boolean)[], TLeader extends string> = UnionToTuple<{
    [K in keyof TList]: AsString<TList[K]> extends string ? EnsureLeading<AsString<TList[K]>, TLeader> : never;
}[number]>;
//# sourceMappingURL=EnsureLeadingEvery.d.ts.map