...
export type LifoQueue<TType> = {
     ...
     */
    take<T extends number | undefined>(quantity?: T): FixedLengthArray<TType, T extends undefined ? 1 : T>;
    [Symbol.iterator](): Iterator<TType>;
};
//# sourceMappingURL=LifoQueue.d.ts.map