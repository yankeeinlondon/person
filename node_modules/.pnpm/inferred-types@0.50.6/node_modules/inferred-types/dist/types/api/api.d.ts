import { Dictionary, EmptyObject, TypedFunction, Values, Throw, AfterFirst, First, ExpandRecursively, TupleToUnion, Unset, PublicKeyOf, IfUnset, KeyOf, Fail, Extends, UpsertKeyValue, Tuple, ReduceValues, IsEscapeFunction, RemoveNever, If, WhenNever, HasEscapeFunction, ErrorCondition } from "src/types/index";
/**
...
export type FluentFn<TState, TName extends string, TFn extends <TCb extends (<T extends FluentState<TState>>(state: T) => TypedFunction<TState>), TOnce extends boolean>(cb: TCb, useOnce?: TOnce) => void, TOnce extends boolean = false> = {
    name: TName;
    fn: TFn;
    useOnce: TOnce;
};
type ExpandFluentFns<TFluentState extends FluentState<any>, TFns extends readonly FluentFn<TFluentState["state"], any, any>[], TFluentApi extends Dictionary = EmptyObject> = [] extends TFns ? TFluentApi : ExpandFluentFns<TFluentState, AfterFirst<TFns>, TFluentApi & Record<First<TFns>["name"], First<TFns>["fn"]>>;
/**
