 ...
 * ```
 */
export type ConvertSet<TSet extends readonly unknown[], TConversions extends ConversionTuple | readonly ConversionTuple[]> = TConversions extends readonly ConversionTuple[] ? ConvertAcc<TSet, TConversions> : TConversions extends ConversionTuple ? ConvertAcc<TSet, readonly [TConversions]> : never;
export {};
//# sourceMappingURL=ConvertSet.d.ts.map