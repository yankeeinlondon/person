 ...
 */
export type LeftRight<L = unknown, R = unknown> = [kind: "LeftRight", left: L, right: R];
/**
 * **AsLeftRight**`<A,B>`
 *
 ...
 */
export type IsSingleSided<T extends LeftRight> = T extends [Defined, undefined] ? true : T extends [undefined, Defined] ? true : false;
/**
 * **AsLeft**`<T>`
 *
 ...
 * Checks that
 */
export type IfLeft<T extends LeftRight> = IsSingleSided<T> extends true ? T[left] extends Defined ? true : false : never;
/**
 * **AsRight**`<T>`
 *
 ...
 * of an array
 */
export type AppendRight<TErr, TExisting extends LeftRight> = TExisting[right] extends Tuple ? [...TExisting[right], TErr] : [TErr];
/**
 ...
 */
export type LeftExtends<TEval, TLeftRight extends LeftRight> = TEval extends TLeftRight[left] ? true : false;
/**
 ...
 * the _left_ value of `TLeftRight`
 */
export type LeftEquals<TEval, TLeftRight extends LeftRight> = IfEqual<TEval, TLeftRight[left], true, false>;
/**
 * **LeftIncludes**
 *
 ...
 */
export type LeftIncludes<TEval, TLeftRight extends LeftRight> = TLeftRight[left] extends string ? TEval extends string | readonly string[] ? Contains<TEval, TLeftRight[left]> : false : false;
 ...
 */
export type LeftContains<TEval, TLeftRight extends LeftRight, TExplicitness extends Explicitness = "loose"> = TLeftRight[left] extends Tuple ? TExplicitness extends "loose" ? Contains<TLeftRight[left], TEval> : NarrowlyContains<TLeftRight[left], TEval> : false;
/**
 * **LeftExtends**`<TEval,TLeftRight>`
 *
 * Boolean utility which states whether the value of `TEval` _extends_
 ...
 */
export type RightExtends<TEval, TLeftRight extends LeftRight> = TEval extends TLeftRight[right] ? true : false;
/**
 ...
 * the _right_ value of `TLeftRight`
 */
export type RightEquals<TEval, TLeftRight extends LeftRight> = IfEqual<TEval, TLeftRight[right], true, false>;
/**
 * **RightIncludes**
 *
 * Boolean utility which validates that at least one of the strings segments
 ...
 */
export type RightIncludes<TEval, TLeftRight extends LeftRight> = TLeftRight[right] extends string ? TEval extends string | readonly string[] ? Contains<TEval, TLeftRight[right]> : false : false;
/**
 * **RightContains**
 *
 ...
 */
export type RightContains<TEval, TLeftRight extends LeftRight, TExplicitness extends Explicitness = "loose"> = TLeftRight[left] extends Tuple ? TExplicitness extends "loose" ? Contains<TLeftRight[left], TEval> : NarrowlyContains<TLeftRight[left], TEval> : false;
export type LeftRight__Operations = "extends" | "equals" | "includes" | "contains";
/**
 ...
 */
export type WhereLeft<TEval, TOp extends LeftRight__Operations, TLeftRight extends LeftRight, IF = TEval & TLeftRight[left], ELSE = AsError<[
...
]>> = TOp extends "extends" ? LeftExtends<TEval, TLeftRight> extends true ? IF : ELSE : TOp extends "equals" ? LeftEquals<TEval, TLeftRight> extends true ? IF : ELSE : TOp extends "includes" ? LeftIncludes<TEval, TLeftRight> extends true ? IF : ELSE : TOp extends "contains" ? LeftContains<TEval, TLeftRight> extends true ? IF : ELSE : never;
export {};
