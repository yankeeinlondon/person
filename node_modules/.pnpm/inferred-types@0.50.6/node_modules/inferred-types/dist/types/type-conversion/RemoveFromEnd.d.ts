 ...
 */
export type RemoveFromEnd<TContent extends string, TRemove extends string> = TContent extends `${infer Start}${TRemove}` ? Start : TContent;
//# sourceMappingURL=RemoveFromEnd.d.ts.map