...
type Process<U, Last = LastInUnion<U>> = [U] extends [never] ? [] : [IsUnion<U>] extends [true] ? [Last, Exclude<U, Last>] : U;
/**
 * **ShiftUnion**`<U>`
 *
 ...
 */
export type UnionShift<U, Last = LastInUnion<U>> = Process<U, Last> extends readonly unknown[] ? IsUnion<U> extends true ? [Last, Exclude<U, Last>] : U : [never, IsUnion<U> extends true ? [Last, Exclude<U, Last>] : U];
export {};
//# sourceMappingURL=UnionShift.d.ts.map