import { Container, ErrorCondition, IsEqual, IsNever, IsVueRef, IsWideUnion, ObjectKey, ProxyError, RemoveIndexKeys, Scalar, Throw, UnionToTuple } from "src/types/index";
/**
 * **IsWideScalar**`<T>`
 *
