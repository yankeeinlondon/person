import { IsStringLiteral, GetPhoneCountryCode, IsTrue, PhoneNumber, PhoneCountryCode, IsErrorCondition, MaybeError } from "src/types/index";
/**
 * **IsPhoneNumber**`<T>`
 *
 ...
 */
export type IsPhoneNumber<T extends string | number> = IsErrorCondition<PhoneNumber<T>> extends true ? false : MaybeError<PhoneNumber<T>> extends true ? boolean : true;
/**
 ...
 */
export type HasPhoneCountryCode<TPhone, TExplicit extends boolean = true> = TPhone extends string ? IsStringLiteral<TPhone> extends true ? IsTrue<TExplicit> extends true ? GetPhoneCountryCode<TPhone> extends PhoneCountryCode ? true : false : GetPhoneCountryCode<TPhone> extends "" ? false : true : boolean : false;
//# sourceMappingURL=PhoneOperators.d.ts.map