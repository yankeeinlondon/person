import type { GetEach } from "src/types/index";
 ...
 */
export declare function getEach<TList extends readonly unknown[], TDotPath extends string | null>(list: TList, dotPath: TDotPath): GetEach<[...TList], TDotPath>;
