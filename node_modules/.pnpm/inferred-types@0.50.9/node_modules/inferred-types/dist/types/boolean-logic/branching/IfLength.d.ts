 ...
 * type.
 */
export type IfLength<TEvaluate extends Tuple | string, TLength extends number, IF, ELSE = TEvaluate, MAYBE = IF | ELSE> = TEvaluate extends readonly unknown[] ? IsNumericLiteral<TLength> extends true ? IfEqual<Length<TEvaluate>, TLength, IF, ELSE> : MAYBE : TEvaluate extends unknown[] ? MAYBE : TEvaluate extends string ? If<IsStringLiteral<TEvaluate>, IfEqual<Length<TEvaluate>, TLength, IF, ELSE>, MAYBE> : MAYBE;
//# sourceMappingURL=IfLength.d.ts.map