...
type AnyError<T extends readonly unknown[]> = Contains<T, ErrorCondition> extends true ? true : Contains<T, Error> extends true ? true : false;
/**
 * **MaybeError**`<T>`
 *
 ...
 */
export type MaybeError<T> = IsUnion<T> extends true ? AnyError<UnionToTuple<T>> : false;
export {};
//# sourceMappingURL=MaybeError.d.ts.map