...
]> extends true ? string : Or<[IsEqual<TOp, "lessThan">, IsEqual<TOp, "greaterThan">]> extends true ? NumberLike : unknown> = TContainer extends readonly unknown[] ? Process<TContainer, TOp, TComparator> : TContainer extends Dictionary ? Process<Values<TContainer>, TOp, TComparator> : never;
export {};
