 ...
 */
export type IsLessThan<A extends NumberLike, B extends NumberLike> = Calc<AsNumber<A>, AsNumber<B>>;
/**
 * **IsLessThanOrEqual**`<A,B>`
 *
 * Test whether `A` is _less than_ or _equal_ to `B`.
 */
export type IsLessThanOrEqual<A extends NumberLike, B extends NumberLike> = IsEqual<A, B> extends true ? true : IsLessThan<A, B>;
export {};
