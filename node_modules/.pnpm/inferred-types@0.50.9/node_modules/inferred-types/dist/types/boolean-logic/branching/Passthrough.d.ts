 ...
 * **Related:** `THandle`
 */
export type Passthrough<TContent, TPass, THandle, TSpecificity extends "extends" | "equals" = "extends"> = IfEquals<TSpecificity, "extends", TContent extends TPass ? TContent : THandle, IfEquals<TContent, TPass, TContent, THandle>>;
