...
export type WideTokenNames = "string" | "number" | "boolean" | "null" | "undefined" | "never" | "unknown" | "string[]" | "number[]" | "boolean[]" | "unknown[]";
...
export type WideContainerNames = "object" | "Dictionary" | "Map" | "Set" | "WeakMap";
type ConvertWideContainerNames<T extends WideContainerNames> = T extends "object" ? object : T extends "Dictionary" ? Record<ObjectKey, unknown> : T extends "Map" ? Map<unknown, unknown> : T extends "Set" ? Set<unknown> : T extends "WeakMap" ? WeakMap<object, unknown> : never;
/**
 ...
 */
export type FromWideTokens<T, TElse = never> = T extends WideTokenNames | WideContainerNames ? T extends WideTokenNames ? ConvertWideTokenNames<T> : T extends WideContainerNames ? ConvertWideContainerNames<T> : never : IsNever<TElse> extends true ? T : TElse;
export {};
//# sourceMappingURL=FromTokenNames.d.ts.map