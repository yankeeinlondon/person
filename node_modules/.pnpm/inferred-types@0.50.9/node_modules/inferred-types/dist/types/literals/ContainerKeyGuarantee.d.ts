 ...
 */
export type ContainerKeyGuarantee<TContainer extends Container, TKey extends PropertyKey, TType = unknown> = TContainer extends Tuple ? TContainer & Readonly<[...Tuple<unknown, TKey & number>, TType]> : ExpandRecursively<TContainer & Record<TKey, TType>>;
//# sourceMappingURL=ContainerKeyGuarantee.d.ts.map