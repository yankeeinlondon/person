 ...
 * **Related:** `AsFn`
 */
export type ToFn<T> = T extends AnyFunction ? T : T extends FnMeta<infer _Args, infer _Returns, infer Props, infer Fn> ? IsNever<Props> extends true ? Fn : Fn & Props : () => T;
//# sourceMappingURL=ToFn.d.ts.map