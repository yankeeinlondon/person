 ...
 */
export type UniqueKeys<L extends Container, R extends Container> = LeftRight<AsNumberWhenPossible<UnionToTuple<Exclude<keyof L, keyof R>>>, AsNumberWhenPossible<UnionToTuple<Exclude<keyof R, keyof L>>>>;
//# sourceMappingURL=UniqueKeys.d.ts.map