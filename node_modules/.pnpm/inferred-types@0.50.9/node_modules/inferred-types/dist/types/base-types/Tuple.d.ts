 ...
 * ```
 */
export type Tuple<TType = unknown, TLength extends number | TupleRange | `${number}+` = 0> = 0 extends TLength ? TType extends any[] ? Readonly<TType> : readonly TType[] : TLength extends number ? Readonly<FixedLengthArray<TType, TLength>> : TLength extends TupleRange ? Readonly<[
