import { EmptyObject, ExpandRecursively, IsEqual, If, IsNever, Dictionary, RemoveIndex, RemoveIndexKeys, UnionToTuple } from "src/types/index";
 ...
 */
export type IndexableObject<TObj extends Dictionary = Dictionary, TIndex extends Dictionary = Dictionary> = If<IsNever<TObj>, never, If<IsEqual<TObj, EmptyObject>, Dictionary, If<IsNever<Len<TObj>>, Dictionary, ExpandRecursively<TIndex & RemoveIndex<TObj>>>>>;
export {};
//# sourceMappingURL=IndexableObject.d.ts.map