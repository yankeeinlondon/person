 ...
 */
export type AsNumericArray<T> = T extends readonly unknown[] ? RemoveNever<{
    [K in keyof T]: T[K] extends NumberLike ? AsNumber<T[K]> : never;
}> : never;
//# sourceMappingURL=AsNumericArray.d.ts.map