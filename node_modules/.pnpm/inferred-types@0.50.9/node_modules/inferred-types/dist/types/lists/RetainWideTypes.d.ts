...
type Process<T extends readonly unknown[]> = RemoveMarked<{
 ...
 */
export type RetainWideTypes<T extends readonly unknown[]> = Process<T> extends readonly unknown[] ? Process<T> : never;
export {};
//# sourceMappingURL=RetainWideTypes.d.ts.map