import { TEMPERATURE_METRICS_LOOKUP } from "src/constants/index";
...
export type TemperatureMetrics = {
    [K in keyof TemperatureMetricsLookup]: "name" extends keyof TemperatureMetricsLookup[K] ? TemperatureMetricsLookup[K]["name"] : never;
}[number];
/**
 * Unit of measure for metrics associated with **Temperature**.
 */
export type TemperatureUom = {
    [K in keyof TemperatureMetricsLookup]: "abbrev" extends keyof TemperatureMetricsLookup[K] ? TemperatureMetricsLookup[K]["abbrev"] : never;
}[number];
/***
 * **Temperature**
 *
