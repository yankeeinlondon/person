import { First, UnionToTuple } from "src/types/index";
 ...
 * 1, or many outputs.
 */
export type CardinalityFilter0 = ZeroToOne | ZeroToMany | OneToOne | OneToMany | OneToZero | ZeroToZero;
export type CardinalityExplicit = `${number}:${number}`;
/**
 * Cardinality of any sort between two types
 */
export type Cardinality = CardinalityFilter0 | CardinalityFilter1 | ManyToMany | ManyToOne | ManyToZero | CardinalityExplicit;
/**
 ...
 */
export type CardinalityOut<T extends Cardinality> = T extends `${string}:${infer OUT}` ? OUT : never;
export type CardinalityInput<T, C extends Cardinality> = UnionToTuple<C> extends readonly unknown[] ? First<UnionToTuple<C>> extends 1 ? T : T[] : T | undefined;
