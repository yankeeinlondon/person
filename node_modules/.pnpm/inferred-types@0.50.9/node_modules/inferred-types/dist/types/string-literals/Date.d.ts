import { NumericChar, NonZeroNumericChar } from "src/types/index";
import type { MONTH_ABBR, MONTH_NAME } from "src/constants/index";
export type Year<T extends "strong" | "simple" = "strong"> = T extends "strong" ? `${"1" | "2"}${NumericChar}${NumericChar}${NumericChar}` : `${"1" | "2"}${number}`;
 ...
 */
export type YMD<TSep extends DateSeparator = "-"> = `${"1" | "2"}${number}${TSep}${MonthNumeric}${TSep}${number}`;
/**
 * **DateThenMonth**
 *
