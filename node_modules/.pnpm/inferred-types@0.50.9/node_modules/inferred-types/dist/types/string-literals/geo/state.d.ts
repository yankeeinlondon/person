...
type _UsStateAbbrev = {
    [K in keyof UsStateLookup]: UsStateLookup[K] extends {
        abbrev: infer A extends string;
    } ? A : never;
}[number];
type _UsProvinceAbbrev = {
    [K in keyof UsProvinceLookup]: UsProvinceLookup[K] extends {
        abbrev: infer A extends string;
    } ? A : never;
}[number];
/**
 ...
 */
export type UsStateAbbrev<TStrict extends boolean = false> = IsTrue<TStrict> extends true ? Exclude<_UsStateAbbrev, _UsProvinceAbbrev> : _UsStateAbbrev;
type _UsStateName = {
    [K in keyof UsStateLookup]: UsStateLookup[K] extends {
 ...
 * **Related:** `UsStateAbbrev`
 */
export type UsStateName<TStrict extends boolean = false> = IsTrue<TStrict> extends true ? Exclude<_UsStateName, _UsProvinceName> : _UsStateName;
export {};
