import { AREA_METRICS_LOOKUP } from "src/constants/index";
...
export type AreaMetrics = {
    [K in keyof AreaMetricsLookup]: "name" extends keyof AreaMetricsLookup[K] ? AreaMetricsLookup[K]["name"] : never;
}[number];
/**
 * Unit of measure for metrics associated with **Area**.
 */
export type AreaUom = {
    [K in keyof AreaMetricsLookup]: "abbrev" extends keyof AreaMetricsLookup[K] ? AreaMetricsLookup[K]["abbrev"] : never;
}[number];
/***
 * **Area**
 *
