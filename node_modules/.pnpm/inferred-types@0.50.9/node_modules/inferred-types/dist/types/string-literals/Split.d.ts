import { AfterFirst, BeforeLast, Chars, Filter, First, IsUnion, IsStringLiteral, IsWideType, Last, TupleToUnion, UnionToTuple, As } from "src/types/index";
...
TSep, TUnionPolicy, First<TContent> extends TSep ? [
    ...TResult,
    ...(TUnionPolicy extends "omit" ? [""] : [First<TContent>])
] : Last<TResult, ""> extends string ? First<TContent> extends string ? BeforeLast<TResult> extends readonly string[] ? [
    ...BeforeLast<TResult>,
    `${Last<TResult>}${First<TContent>}`
] : never : never : never>;
type LiteralSplit<TContent extends string, TSep extends string, TUnionPolicy extends UnionPolicy = "omit", TResults extends readonly string[] = []> = TContent extends `${infer Block}${TSep}${infer Rest}` ? LiteralSplit<Rest, TSep, TUnionPolicy, [
    ...TResults,
