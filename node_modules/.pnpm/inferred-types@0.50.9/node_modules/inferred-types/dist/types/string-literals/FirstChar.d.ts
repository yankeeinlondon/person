import { First, Chars } from "src/types/index";
 ...
 */
export type FirstChar<TContent extends string | readonly string[]> = TContent extends readonly string[] ? Iterate<TContent> : TContent extends string ? string extends TContent ? string : Process<TContent> : never;
export {};
//# sourceMappingURL=FirstChar.d.ts.map