import { CURRENT_METRICS_LOOKUP } from "src/constants/index";
...
export type CurrentMetrics = {
    [K in keyof CurrentMetricsLookup]: "name" extends keyof CurrentMetricsLookup[K] ? CurrentMetricsLookup[K]["name"] : never;
}[number];
/**
 * Unit of measure for metrics associated with **Current**.
 */
export type CurrentUom = {
    [K in keyof CurrentMetricsLookup]: "abbrev" extends keyof CurrentMetricsLookup[K] ? CurrentMetricsLookup[K]["abbrev"] : never;
}[number];
/***
 * **Current**
 *
