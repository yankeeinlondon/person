...
type AlphaNumericAcc<T extends string, TResult extends string> = T extends "" ? TResult : T extends `${AlphaNumericChar}${infer REST}` ? AlphaNumericAcc<REST, TResult> : never;
/**
 * **AlphaNumeric**`<T>`
 *
 ...
 */
export type AlphaNumeric<T extends string> = IsStringLiteral<T> extends true ? AlphaNumericAcc<T, T> : never;
export {};
