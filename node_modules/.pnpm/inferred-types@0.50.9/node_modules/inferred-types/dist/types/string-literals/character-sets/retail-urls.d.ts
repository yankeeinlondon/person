import { AMAZON_DNS, APPLE_DNS, BEST_BUY_DNS, CHEWY_DNS, COSTCO_DNS, CVS_DNS, DELL_DNS, EBAY_DNS, ETSY_DNS, HM_DNS, HOME_DEPOT_DNS, IKEA_DNS, KROGER_DNS, LOWES_DNS, MACYS_DNS, NIKE_DNS, TARGET_DNS, WALGREENS_DNS, WALMART_DNS, WAYFAIR_DNS, WHOLE_FOODS_DNS, ZARA_DNS } from "src/constants/index";
...
//# sourceMappingURL=retail-urls.d.ts.map