import { SPEED_METRICS_LOOKUP } from "src/constants/index";
...
export type SpeedMetrics = {
    [K in keyof SpeedMetricsLookup]: "name" extends keyof SpeedMetricsLookup[K] ? SpeedMetricsLookup[K]["name"] : never;
}[number];
/**
 * Unit of measure for metrics associated with **Speed**.
 */
export type SpeedUom = {
    [K in keyof SpeedMetricsLookup]: "abbrev" extends keyof SpeedMetricsLookup[K] ? SpeedMetricsLookup[K]["abbrev"] : never;
}[number];
/***
 * **Speed**
 *
