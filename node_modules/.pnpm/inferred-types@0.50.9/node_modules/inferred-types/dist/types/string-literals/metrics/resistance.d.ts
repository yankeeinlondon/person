import { RESISTANCE_METRICS_LOOKUP } from "src/constants/index";
...
export type ResistanceMetrics = {
    [K in keyof ResistanceMetricsLookup]: "name" extends keyof ResistanceMetricsLookup[K] ? ResistanceMetricsLookup[K]["name"] : never;
}[number];
/**
 * Unit of measure for metrics associated with **resistance**.
 */
export type ResistanceUom = {
    [K in keyof ResistanceMetricsLookup]: "abbrev" extends keyof ResistanceMetricsLookup[K] ? ResistanceMetricsLookup[K]["abbrev"] : never;
}[number];
/***
 * **Resistance**
 *
