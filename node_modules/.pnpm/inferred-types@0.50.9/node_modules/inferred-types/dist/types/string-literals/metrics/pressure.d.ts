import { PRESSURE_METRICS_LOOKUP } from "src/constants/index";
...
export type PressureMetrics = {
    [K in keyof PressureMetricsLookup]: "name" extends keyof PressureMetricsLookup[K] ? PressureMetricsLookup[K]["name"] : never;
}[number];
/**
 * Unit of measure for metrics associated with **Pressure**.
 */
export type PressureUom = {
    [K in keyof PressureMetricsLookup]: "abbrev" extends keyof PressureMetricsLookup[K] ? PressureMetricsLookup[K]["abbrev"] : never;
}[number];
/***
 * **Pressure**
 *
