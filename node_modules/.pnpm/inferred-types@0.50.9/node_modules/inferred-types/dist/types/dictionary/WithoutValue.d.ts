 ...
 */
export type WithoutValue<TObj extends AnyObject, TValue extends Narrowable> = ExpandRecursively<Pick<TObj, KeysWithoutValue<TObj, TValue>>>;
//# sourceMappingURL=WithoutValue.d.ts.map