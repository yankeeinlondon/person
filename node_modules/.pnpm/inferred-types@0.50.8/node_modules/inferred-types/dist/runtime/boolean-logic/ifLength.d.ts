 ...
 */
export declare function ifLength<TList extends readonly unknown[], TLen extends number, IF extends Narrowable | Tuple, ELSE extends Narrowable | Tuple>(value: TList, length: TLen, ifVal: <V extends Exclude<TList, Scalar | undefined> & Tuple>(v: V) => IF, elseVal: <V extends If<IsArray<TList>, TList, Exclude<TList, Tuple>>>(v: V) => ELSE): IfLength<TList, TLen, IF, ELSE>;
