...
export type AsClassSelector<T extends CssSelectorOptions | undefined> = If<IsUndefined<T>, CssSelector<CssIdSelector, CssClassSelector, CssTagSelector, CssPseudoClass>, T extends CssSelectorOptions ? CssSelector<If<IsUndefined<T["ids"]>, CssIdSelector, TupleToUnion<T["ids"]>>, If<IsUndefined<T["classes"]>, CssClassSelector, TupleToUnion<T["classes"]>>, If<IsUndefined<T["tags"]>, CssTagSelector, TupleToUnion<T["tags"]>>, If<IsUndefined<T["pseudo"]>, CssPseudoClass, TupleToUnion<T["pseudo"]>>> : never>;
/**
