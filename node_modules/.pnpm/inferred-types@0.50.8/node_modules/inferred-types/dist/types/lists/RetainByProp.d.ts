import { ComparatorOperation, Compare, IsArray, IfNever, If, TupleToUnion, RemoveNever, IsDotPath, Throw, Get } from "src/types/index";
/**
...
] extends [true] ? SingleFilter<Rest, TComparator, TProp, TOp, [...Result, Head]> : SingleFilter<Rest, TComparator, TProp, TOp, Result> : Result;
type Process<TList extends unknown[] | readonly unknown[], TComparator, TProp extends string, TOp extends ComparatorOperation> = TList extends unknown[] ? SingleFilter<TList, TComparator, TProp, TOp> : TList extends readonly unknown[] ? Readonly<SingleFilter<[...TList], TComparator, TProp, TOp>> : never;
/**
