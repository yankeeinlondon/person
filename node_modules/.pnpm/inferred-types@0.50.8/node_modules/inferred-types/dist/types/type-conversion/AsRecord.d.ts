 ...
 */
export type AsRecord<T extends Dictionary | object> = T extends Tuple ? T : T extends Dictionary ? T : T extends object ? T extends any[] ? never : NonNullable<unknown> : never;
