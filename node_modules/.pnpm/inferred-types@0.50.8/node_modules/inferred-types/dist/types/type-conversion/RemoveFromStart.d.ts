 ...
 */
export type RemoveFromStart<TContent extends string, TRemove extends string> = TContent extends `${TRemove}${infer Rest}` ? Rest : TContent;
//# sourceMappingURL=RemoveFromStart.d.ts.map