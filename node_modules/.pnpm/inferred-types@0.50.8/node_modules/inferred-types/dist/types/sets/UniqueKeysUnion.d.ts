import { Container, LeftRight } from "src/types/index";
/**
 * **UniqueKeysUnion**`<L,R>`
 *
 ...
 * **Related:** `UniqueKeys`
 */
export type UniqueKeysUnion<L extends Container, R extends Container> = LeftRight<Exclude<keyof L, keyof R>, Exclude<keyof R, keyof L>>;
//# sourceMappingURL=UniqueKeysUnion.d.ts.map