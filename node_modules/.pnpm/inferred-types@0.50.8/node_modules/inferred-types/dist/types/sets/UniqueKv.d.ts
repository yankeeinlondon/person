import { AnyObject, LeftRight } from "src/types/index";
/**
 * **UniqueKv**`<L,R>`
 *
 ...
 */
export type UniqueKv<L extends AnyObject, R extends AnyObject> = LeftRight<Exclude<L, keyof (L & R)>, Exclude<R, keyof (L & R)>>;
//# sourceMappingURL=UniqueKv.d.ts.map