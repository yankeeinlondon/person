 ...
 * **Related:** `THandle`
 */
export type Handle<TContent, THandle, TMapTo, TSpecificity extends "extends" | "equals" = "extends"> = [
    THandle
] extends never[] ? [TContent] extends never[] ? TMapTo : TContent : TSpecificity extends "extends" ? [TContent] extends [THandle] ? TMapTo : Narrow<TContent, THandle> : If<IsEqual<[TContent], [THandle]>, TMapTo, TContent>;
export {};
