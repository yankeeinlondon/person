...
export type CssColorSpace = "srgb" | "srgb-linear" | "p3-display" | "rec2020" | "a98-rgb" | "prophoto-rgb" | "xyz" | "xyz-d50" | "xyz-d65";
 ...
 */
export type CssColorFn<TColorSpace extends CssColorSpace = CssColorSpace, TV1 extends ColorFnValue = ColorFnValue, TV2 extends ColorFnValue = ColorFnValue, TV3 extends ColorFnValue = ColorFnValue, TOp extends ColorFnOptOpacity = ColorFnOptOpacity> = `color(${TColorSpace} ${TV1} ${TV2} ${TV3})${TOp}` | `color(${CssColor} from ${TColorSpace} ${TV1} ${TV2} ${TV3})${TOp}`;
/**
 * **CssColor**
 *
 * Intended to represent _any_ CSS color value.
 */
export type CssColor = CssHexColor | CssRgb | CssRgba | CssOkLch | CssHsb | CssHsl | `color(${string})`;
export {};
