import { Last, Chars } from "src/types/index";
 ...
 */
export type LastChar<TContent extends string | readonly string[]> = TContent extends readonly string[] ? Iterate<TContent> : TContent extends string ? string extends TContent ? string : Process<TContent> : never;
export {};
//# sourceMappingURL=LastChar.d.ts.map