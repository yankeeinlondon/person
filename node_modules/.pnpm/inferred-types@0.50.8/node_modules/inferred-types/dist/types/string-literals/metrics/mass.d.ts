...
export type MassMetrics = {
    [K in keyof MassMetricsLookup]: "name" extends keyof MassMetricsLookup[K] ? MassMetricsLookup[K]["name"] : never;
}[number];
/**
 * Unit of measure for metrics associated with **Mass**.
 */
export type MassUom = {
    [K in keyof MassMetricsLookup]: "abbrev" extends keyof MassMetricsLookup[K] ? MassMetricsLookup[K]["abbrev"] : never;
}[number];
/***
 * **Mass**
 *
