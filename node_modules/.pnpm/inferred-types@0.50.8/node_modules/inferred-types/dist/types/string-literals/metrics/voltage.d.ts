import { VOLTAGE_METRICS_LOOKUP } from "src/constants/index";
...
export type VoltageMetrics = {
    [K in keyof VoltageMetricsLookup]: "name" extends keyof VoltageMetricsLookup[K] ? VoltageMetricsLookup[K]["name"] : never;
}[number];
/**
 * Unit of measure for metrics associated with **Voltage**.
 */
export type VoltageUom = {
    [K in keyof VoltageMetricsLookup]: "abbrev" extends keyof VoltageMetricsLookup[K] ? VoltageMetricsLookup[K]["abbrev"] : never;
}[number];
/***
 * **Voltage**
 *
