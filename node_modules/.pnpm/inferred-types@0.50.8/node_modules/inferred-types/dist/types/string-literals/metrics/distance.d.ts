...
export type DistanceMetrics = {
    [K in keyof DistanceMetricsLookup]: "name" extends keyof DistanceMetricsLookup[K] ? DistanceMetricsLookup[K]["name"] : never;
}[number];
/**
 * Unit of measure for metrics associated with **distance**.
 */
export type DistanceUom = {
    [K in keyof DistanceMetricsLookup]: "abbrev" extends keyof DistanceMetricsLookup[K] ? DistanceMetricsLookup[K]["abbrev"] : never;
}[number];
/***
 * **Distance**
 *
