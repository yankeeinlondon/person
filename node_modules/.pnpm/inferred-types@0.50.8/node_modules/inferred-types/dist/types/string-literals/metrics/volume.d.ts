import { VOLUME_METRICS_LOOKUP } from "src/constants/index";
...
export type VolumeMetrics = {
    [K in keyof VolumeMetricsLookup]: "name" extends keyof VolumeMetricsLookup[K] ? VolumeMetricsLookup[K]["name"] : never;
}[number];
/**
 * Unit of measure for metrics associated with **Volume**.
 */
export type VolumeUom = {
    [K in keyof VolumeMetricsLookup]: "abbrev" extends keyof VolumeMetricsLookup[K] ? VolumeMetricsLookup[K]["abbrev"] : never;
}[number];
/***
 * **Volume**
 *
