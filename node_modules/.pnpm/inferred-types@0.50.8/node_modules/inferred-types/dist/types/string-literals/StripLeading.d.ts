import { And, AsNumber, AsStringUnion, IsStringLiteral } from "src/types/index";
 ...
 *   - same applies to `U`
 */
export type StripLeading<TContent extends string | number, TStrip extends string | number> = TContent extends number ? AsNumber<Process<`${TContent}`, AsStringUnion<TStrip>>> : TContent extends string ? Process<TContent, AsStringUnion<TStrip>> : never;
export {};
